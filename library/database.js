...
global.db = JSON.parse(i.readFileSync('./library/database/database.json', 'utf-8'));
async function saveDb() {
    i.writeFileSync('./library/database/database.json', JSON.stringify(global.db, null, 2));
}
